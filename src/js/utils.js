...
import { STATE } from "..";
import { SETTINGS_BASE_TEXTURE, SETTINGS_SVG_RESOURCE } from "../constants/assets";

export async function formatPictureToElement(app, levelType, size, isPositioned = true) {
...
export async function goToLevel(app, levelType) {
...
export async function waitLoadBaseRexture(baseTexture) {
...
export async function createTextureFromHTMLElement(element) {
    const resource = new SVGResource(element, SETTINGS_SVG_RESOURCE);
    const baseTexture = new BaseTexture(resource, SETTINGS_BASE_TEXTURE);
    const texture = new Texture(baseTexture);
    await waitLoadBaseRexture(baseTexture);
